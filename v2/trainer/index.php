...
$pageTitle='Trainer dashboard'; $pageSubtitle='Classes, enrollments, and attendance'; include V2_ROOT.'/includes/header.php';
?>
...
<section class="panel"><h2>Upcoming classes</h2><div class="table-wrap"><table><thead><tr><th>Class</th><th>Starts</th><th>Location</th><th>Status</th></tr></thead><tbody><?php foreach($upcoming as $row): ?><tr><td><?= e($row['Name']) ?></td><td><?= e($row['StartsAt']) ?></td><td><?= e($row['Location']??'—') ?></td><td><?= e($row['Status']) ?></td></tr><?php endforeach; ?><?php if(!$upcoming): ?><tr><td colspan="4">No upcoming classes.</td></tr><?php endif; ?></tbody></table></div></section>
