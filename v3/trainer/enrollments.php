...
?>
<section aria-labelledby="enrollment-requests-title">
<h2 class="sr-only" id="enrollment-requests-title">Class enrollment requests</h2>
<div class="table-wrap"><table>
  <caption class="sr-only">Class enrollment requests</caption>
